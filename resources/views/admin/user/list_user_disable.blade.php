...
<div id="content" class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
                    ...
                    @foreach ($users as $user)
                     ...
                     @endphp
                      ...
                      <td>{{$k}}</td>
                        ...
                        <td>
                            <a href="{{route('user.restore',$user->id)}}"  class="btn btn-success btn-sm rounded-0 text-white" type="button" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></a>
                            <a href="{{route('user.permanently_delete',$user->id)}}" class="btn btn-danger btn-sm rounded-0 text-white" type="button" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                    @endforeach
            ...
            @else
            <div class="container">
                  <p class="text-center">Không có tài khoản nào bị vô hiệu hóa</p> 
            </div>
