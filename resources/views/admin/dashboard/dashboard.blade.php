   ...
   <div class="row">
        <div class="col">
            <div class="card text-white bg-primary mb-3" style="max-width: 18rem;">
                ...
                <div class="card-body">
                    <h5 class="card-title">{{$order_success}}</h5>
        ...
        <div class="col">
            <div class="card text-white bg-danger mb-3" style="max-width: 18rem;">
                ...
                <div class="card-body">
                    <h5 class="card-title">{{count($new_orders)}}</h5>
        ...
        <div class="col">
            <div class="card text-white bg-dark mb-3" style="max-width: 18rem;">
                ...
                <div class="card-body">
                    <h5 class="card-title">{{$order_fail}}</h5>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    @endphp
                        ...
                        <td>{{number_format($order->product->price*$order->num_order,0,'.','.')}}đ</td>
