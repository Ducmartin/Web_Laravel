...
<div id="content" class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('product.validation')}}" method="POST" enctype="multipart/form-data" >
                @csrf
                @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" min="1" type="number" name="price" id="name">
                        @error('price')
                        <small class="form-text text-danger">{{$message}}</small>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="detail" class="form-control" id="mytextarea" cols="30" rows="10"></textarea>
                    @error('detail')
                    <small class="form-text text-danger">{{$message}}</small>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="status_id" id="status_id_1" value="3">
                        <label class="form-check-label" for="status_id_1">
                            Còn hàng
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="status_id" id="status_id_2" value="4">
